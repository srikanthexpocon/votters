  ...
  return (
    <div id='dashboard-ecommerce'>
      <Row>
        ...
        <p  style={{textAlign:'left'}} className="card-text">Total Voters</p>
        </div>
            </div>
    </Card>
        </Col>
    ...
    <div className='avatar p-50 m-0' style={{background:'#ff647c'}}>
        ...
        <div className='c-head' >
        <h2 >3000</h2>
        <p className="card-text">Non Voted</p>
        </div>
    </div>
    </Card>
        </Col>
        ...
        <div className='avatar p-50 m-0' style={{background:'#7b61ff'}}>
          ...
          <div className='c-head' >
        <h2>25</h2>
        <p className="card-text">Total Post's</p>
        </div>
</div>
    </Card>
        </Col>
