    ...
    // <img src={cancelImg}></img>
        ...
        <Form>          
          <Row>
            ...
            <Col sm='12'>            
              <Label for='nameVerticalIcons'>Event Name</Label>
              ...
              <InputGroup className='input-group-merge' tag={FormGroup}>
                ...
                <Input type='text' name='name' id='nameVerticalIcons' placeholder='Event Name' />
              </InputGroup>
            </Col>
            <Col sm='12'>
              <Label for='nameVerticalIcons'>Venue</Label>
              <InputGroup className='input-group-merge' tag={FormGroup}>
                <InputGroupAddon addonType='prepend'>
                  <InputGroupText>
                    <Edit2 size={15} />
                ...
                <Input type='text' name='name' id='nameVerticalIcons' placeholder='Venue' />
              </InputGroup>
            </Col>
            <Col sm='12'>
              <Label for='nameVerticalIcons'>Start Date</Label>
              <InputGroup className='input-group-merge' tag={FormGroup}>
                <InputGroupAddon addonType='prepend'>
                <InputGroupText>
                    <Calendar size={15} />
                ...
                <Input type='date' name='name' id='nameVerticalIcons'/>
              </InputGroup>
            </Col>
            <Col sm='12'>
              ...
              <InputGroup className='input-group-merge' tag={FormGroup}>
                ...
                <Input type='date' name='date' id='EmailVerticalIcons' />
                {/* datetime-local */}
              </InputGroup>
            </Col>
            <Col sm='12'>
